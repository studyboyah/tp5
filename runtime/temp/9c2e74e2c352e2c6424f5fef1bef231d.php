<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpStudy\WWW\tp5\public/../application/admin\view\member\add_group.html";i:1538110413;s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" name="add_group" id="add_group" method="post" action="<?php echo url('add_group'); ?>">
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="group_name" type="text" class="form-control" name="car_name" >
                            </div>
                        </div>
                          <div class="form-group">
                        ...
                        <input  type="text" class="form-control" name="qx" value="2" style="display:none">
                        <div class="form-group">
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#group_name').val())){
                layer.msg('请输入骑手名称',{icon:2,time:1500,shade: 0.1}, function(index){
                layer.close(index);
                });
                return false;
            }   
