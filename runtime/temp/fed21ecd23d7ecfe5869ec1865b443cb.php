<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpStudy\WWW\tp5\public/../application/admin\view\config\index.html";i:1513926171;s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <div class="panel-options">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">短信配置</a></li>
                                     <li class=""><a data-toggle="tab" href="#tab-5" aria-expanded="false">底部配置</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-4" class="tab-pane">
                                    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal">  
                                        <div class="hr-line-dashed"></div>                                
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">阿里大于AppKey：</label>
                                            <div class="input-group col-sm-4">                                              
                                                <input type="text" class="form-control" name="config[alidayu_appkey]" value="<?php echo $config['alidayu_appkey']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 请前往阿里大于平台查看AppKey</span>                                           
                                            </div>
                                        </div>                                 
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">阿里大于AppSecret：</label>
                                            <div class="input-group col-sm-4">                                              
                                                <input type="text" class="form-control" name="config[alidayu_appSecret]" value="<?php echo $config['alidayu_appSecret']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 请前往阿里大于平台查看AppSecret</span>                                           
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                 ...
                                 <div id="tab-5" class="tab-pane">
                                    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal">  
                                        <div class="hr-line-dashed"></div>                                
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">商脉微信公众号：</label>
                                            <div class="input-group col-sm-4">                                              
                                                <input type="text" class="form-control" name="config[wchat]" value="<?php echo $config['wchat']; ?>">
                                                <span class="help-block m-b-none"><i class="fa fa-info-circle"></i>商脉微信公众号</span>                                           
                                            </div>
                                        </div>                                 
                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">商脉官方微博：</label>
                                            <div class="input-group col-sm-4">                                              
                                                <input type="text" class="form-control" name="config[weibo]" value="<?php echo $config['weibo']; ?>">
