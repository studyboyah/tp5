<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\product\index.html";i:1513665346;s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('add_list'); ?>"><button class="btn btn-outline btn-primary" type="button">添加作品列表</button></a> 
                    </div>
                </div>                                            
                                    ...
                                    <td>
                                        {{# if(d[i].is_tui==1){ }}
                                            <a href="javascript:;" onclick="is_tui({{d[i].id}});">
                                                <div id="it{{d[i].id}}"><span class="label label-info">是</span></div>
                                            </a>
                                        {{# }else{ }}
                                            <a href="javascript:;" onclick="is_tui({{d[i].id}});">
                                                <div id="it{{d[i].id}}"><span class="label label-danger">否</span></div>
                                            </a>
                                        {{# } }}
                                    </td>                               
                                    <td>
...
<script type="text/javascript">  
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("product/index"); ?>', {
            page: curr || 1,key:key
...
//新闻列表是否推荐
function is_tui(id){
    lunhui.tuijian(id,'<?php echo url("is_tui"); ?>');
}
</script>
</body>
</html>